...
:::caution
ChatGPT en version cloud ne peut **pas** atteindre un serveur MCP qui écoute sur `localhost`. Pour un usage distant, exposez le serveur via un tunnel HTTPS (par exemple [ngrok](https://ngrok.com/), [cloudflared](https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/) ou un déploiement public) et utilisez l'URL publique à la place.
:::
